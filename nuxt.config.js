export default {
    ...
    env: {
        ...
        accountUri: process.env.KEYCLOAK_ACCOUNT_URI ||
    ...
    auth: {
        ...
        strategies: {
            noi: {
                _scheme: 'oauth2',
                authorization_endpoint: process.env.KEYCLOAK_AUTHORIZATION_URI ||
                    'http://localhost:8080/auth/realms/NOI/protocol/openid-connect/auth',
                userinfo_endpoint: process.env.KEYCLOAK_USERINFO_URI ||
