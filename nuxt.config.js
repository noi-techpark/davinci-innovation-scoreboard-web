  ...
  head: {
    ...
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      {
        rel: 'stylesheet',
        href:
          'https://scripts.opendatahub.testingmachine.eu/cookieconsent/cookieconsent.css'
      }
    ],
    script: [
      {
      ...
      {
        src:
          'https://scripts.opendatahub.testingmachine.eu/cookieconsent/cookieconsent.js',
        defer: true,
        body: true
      },
      {
        src:
          'https://scripts.opendatahub.testingmachine.eu/cookieconsent/cookieconsent-init.js',
        defer: true,
        body: true
      }
    ]
